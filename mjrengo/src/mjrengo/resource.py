...
# TODO: mjrengoをtofurengoに変更する
# DEFAULT_BASE_NAMESPACE: str = "tofurengo.data"
DEFAULT_BASE_NAMESPACE: str = "mjrengo.data"
...
def get_resource(
    ...
    Args:
        ...
        base (str): Base module namespace. Defaults to "tofurengo.data".
